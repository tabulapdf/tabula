...
//   2/21/2018  REM; updated resize methods so that startHeaderResize is only activated once per drag operation. Also
...
(function (name, context, definition) {
  ...
  return Backbone.View.extend({
    ...
    initialize: function(data, parentPageView){
      ...
      this.dims = data;
      _.bindAll(this, "startHeaderResize", "resizeHeader", "endHeaderResize");
    ...
    endHeaderResize: function(event){
      this.page.$el.off("mousemove.header");
      this.page.$el.off("mouseleave.header");
      this.page.$el.off("mouseup.header");
      sendback={};
