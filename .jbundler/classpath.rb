...
JBUNDLER_CLASSPATH = []
JBUNDLER_CLASSPATH << (JBUNDLER_LOCAL_REPO + '/technology/tabula/tabula/1.0.2-SNAPSHOT/tabula-1.0.2-SNAPSHOT.jar')
...
JBUNDLER_CLASSPATH << (JBUNDLER_LOCAL_REPO + '/org/apache/pdfbox/fontbox/2.0.8/fontbox-2.0.8.jar')
...
JBUNDLER_CLASSPATH << (JBUNDLER_LOCAL_REPO + '/org/apache/pdfbox/pdfbox/2.0.8/pdfbox-2.0.8.jar')
